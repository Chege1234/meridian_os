...
/**
 * Magic UI — Animated Grid Pattern (vendored)
 * SVG grid with randomly animated highlight squares.
      ...
      resizeObserver = new ResizeObserver((entries) => {
        for (const entry of entries) {
          setDimensions((cur) => {
            ...
            if (cur.width === nextW && cur.height === nextH) return cur
  ...
  return (
    <svg
      ...
      className={cn(
        ...
        "fill-[rgba(77,216,255,0.06)] stroke-[rgba(77,216,255,0.06)]",
        className
      )}
      {...props}
    >
